...
PROFILE_CODE = 'quality'


class AIOperationsQualityPolicy(models.AbstractModel):
    _name = 'ai.operations.quality.policy'
    _description = 'AI Operations quality Policy Wiring'
